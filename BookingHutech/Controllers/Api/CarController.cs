...
namespace BookingHutech.Controllers.Api
{
    public class CarController : ApiController
    {
        ...
        /// <returns>CarInfo</returns> 
        [HttpPost]
        public ApiResponse GetCarInfoByAccountID([FromBody]GetCarInfoByAccountIDRequestModel request)
        {
            try
            {
                if (Permissions.CheckAPIRequest(Request.Headers.GetValues(ApiHeaderKey.BHAPIWebCall.ToString()).First()) == (int)ApiRequestType.Web)
                {
                    try
                    {
                        ...
                        try
                        {
                            var Response = carServices.GetCarInfoByAccountIDServices(request);
                            return ApiResponse.Success(Response);
                        }
                        catch (Exception) // Thực hiện gọi hàm truy vấn ở lớp trên bị lỗi. 
                        {
        ...
        /// <param name="">GetCarInfoByAccountIDRequestModel</param>
        [HttpPost]
        public ApiResponse UpdateCarInfo([FromBody]UpdateCarInfoRequestModel request)
        {
            try
            {
                if (Permissions.CheckAPIRequest(Request.Headers.GetValues(ApiHeaderKey.BHAPIWebCall.ToString()).First()) == (int)ApiRequestType.Web)
        ...
        /// <returns></returns> 
        [HttpPost]
        public ApiResponse CreateNewCar(CreateNewCarRequestModel request)
        {
            try
            {
                // kiểm tra quyền - và nguồn gọi api của WEB HAY MOBILE. 
                if (Permissions.CheckAPIRequest(Request.Headers.GetValues(ApiHeaderKey.BHAPIWebCall.ToString()).First()) == (int)ApiRequestType.Web)
                {
                    try
                    {
                        ...
                        try
                        {
                            carServices.CreateNewCarServices(request);
                            return ApiResponse.Success();
                        }
                        catch // Thực hiện gọi hàm truy vấn ở lớp trên bị lỗi. 
                        {
        ...
        /// </summary>
        /// <param name="">GetCarInfoRequestModel</param>
        /// <returns>GetCarDetail</returns> 
        [HttpPost]
        public ApiResponse GetCarDetail([FromBody]GetReportDetailCarRequestModel request)
        {
            try
            {
                if (Permissions.CheckAPIRequest(Request.Headers.GetValues(ApiHeaderKey.BHAPIWebCall.ToString()).First()) == (int)ApiRequestType.Web)
                {
                    try
                    {
                        ...
                        try
                        {
                            var Response = carServices.GetCarDetailServices(request);
                            return ApiResponse.Success(Response);
                        }
                        catch (Exception) // Thực hiện gọi hàm truy vấn ở lớp trên bị lỗi. 
                        {
