...
namespace BookingHutech.Controllers.Api
{
    public class RegistrationCarController : ApiController
    {
        ...
        /// <param name="CreateNewRegistrationCarRequestModel">CreateNewRegistrationCarRequestModel</param>
        [HttpPut]
        public ApiResponse EditRegistrationCar([FromBody]CreateNewRegistrationCarRequestModel request)
        {
            try
            {
                // kiểm tra quyền, và nguồn gọi. 
        ...
        /// </summary>
        /// <param name="DeleteRegistrationCarRequestModel">DeleteRegistrationCarRequestModel</param>
        [HttpPut]
        public ApiResponse DeleteRegistrationCar([FromBody]DeleteRegistrationCarRequestModel request)
        {
            try
            {
                // kiểm tra quyền, và nguồn gọi. 
