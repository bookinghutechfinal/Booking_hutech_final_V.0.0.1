...
namespace BookingHutech.Api_BHutech.DAO.CarDAO
{
    public class RegistrationCarDAO
    {
        ...
        public List<GetRegistrationCarByCarID> GetRegistrationCarDAO(String stringSql)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (reader["NumberPeople"] != DBNull.Value)
                    {
                    ...
                    if (reader["Profile_Status"] != DBNull.Value)
                    {
            ...
            {
                LogWriter.MyWriteLogData("GetRegistrationCarDAO", stringSql, null, null, ex, "Exc SP = " + stringSql + " fail");
                con.Close();
                throw;
            }
        }
        ...
        public void UpdateRegistrationCarStatusDAO(String sqlStore, UpdateRegistrationCarStatusRequestModel request)
        {
            ...
            {
                con.Close();
                LogWriter.MyWriteLogData("UpdateRegistrationCarStatusDAO", sqlStore, request.ToString(), null, ex, "Exc SP = " + sqlStore + " fail");
                throw;
            }
            finally
            {
        ...
        public void CreateNewRegistrationCarDAO(String sqlStore, CreateNewRegistrationCarRequestModel request)
        {
            ...
            {
                con.Close();
                LogWriter.MyWriteLogData("CreateNewRegistrationCarDAO", sqlStore, request.ToString(), null, ex, "Exc SP = " + sqlStore + " fail");
                throw;
            }
            finally
            {
        ...
        public List<GetListRegistrationCar> GetListRegistrationCarDAO(String stringSql)
        {
            ...
            {
                LogWriter.MyWriteLogData("GetListRegistrationCarDAO", stringSql, null, null, ex, "Exc SP = " + stringSql + " fail");
                con.Close();
                throw;
            }
        }
        ...
        public List<GetListRegistrationCar> GetDetailRegistrationByProfileCarNotRatifyDAO(String stringSql)
        {
            ...
            { 
                LogWriter.MyWriteLogData("GetDetailRegistrationByProfileCarNotRatifyDAO", stringSql, null, null, ex, "Exc SP = " + stringSql + " fail");
                con.Close();
                throw;
            }
        }
        ...
        public List<GetListRegistrationCar> GetDetailRegistrationByProfileCarRatifyDAO(String stringSql)
        {
            ...
            { 
                LogWriter.MyWriteLogData("GetDetailRegistrationByProfileCarRatifyDAO", stringSql, null, null, ex, "Exc SP = " + stringSql + " fail");
                con.Close();
                throw;
            }
        }
        ...
        public void ManagerUpdateRegistrationCarDAO(String sqlStore, UpdateRegistrationCarStatusRequestModel request)
        {
            ...
            {
                con.Close();
                LogWriter.MyWriteLogData("ManagerUpdateRegistrationCarDAO", sqlStore, request.ToString(), null, ex, "Exc SP = " + sqlStore + " fail");
                throw;
            }
            finally
            {
        ...
        public void EditRegistrationCarDAO(String sqlStore, CreateNewRegistrationCarRequestModel request)
        {
            ...
            {
                con.Close(); 
                LogWriter.MyWriteLogData("EditRegistrationCarDAO", sqlStore, request.ToString(), null, ex, "Exc SP = " + sqlStore + " fail");
                throw;
            }
            finally
            {
        ...
        public void DeleteRegistrationCarDAO(String sqlStore, DeleteRegistrationCarRequestModel request)
        {
            ...
            {
                con.Close(); 
                LogWriter.MyWriteLogData("DeleteRegistrationCarDAO", sqlStore, request.ToString(), null, ex, "Exc SP = " + sqlStore + " fail");
                throw;
            }
            finally
            {
